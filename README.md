# Go Micro [![License](https://img.shields.io/:license-apache-blue.svg)](https://opensource.org/licenses/Apache-2.0) [![Go.Dev reference](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=flat-square)](https://pkg.go.dev/github.com/smart-echo/micro?tab=doc) [![Go Report Card](https://goreportcard.com/badge/github.com/go-micro/go-micro)](https://goreportcard.com/report/github.com/go-micro/go-micro)
...
```golang
import "github.com/smart-echo/micro"
```
...
See [github.com/smart-echo](https://github.com/smart-echo) for tooling.
...
See [CHANGELOG.md](https://github.com/smart-echo/micro/tree/master/CHANGELOG.md) for release history.
