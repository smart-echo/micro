// Package kubernetes taken from https://github.com/smart-echo/micro/blob/master/debug/log/kubernetes/kubernetes.go
...
import (
	...
	"github.com/smart-echo/micro/util/kubernetes/client"
)
